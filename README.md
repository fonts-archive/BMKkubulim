...
사용하는 `font-family`의 이름은 `BM Kkubulim`입니다.

### HTML

```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/fonts-archive/BMKkubulim/BMKkubulim.css" type="text/css"/>
```
...
@font-face {
  ...
  font-style: normal;
  font-display: swap;
  src: url('https://cdn.jsdelivr.net/gh/fonts-archive/BMKkubulim/BMKkubulim.woff2') format('woff2'),
      url('https://cdn.jsdelivr.net/gh/fonts-archive/BMKkubulim/BMKkubulim.woff') format('woff'),
      url('https://cdn.jsdelivr.net/gh/fonts-archive/BMKkubulim/BMKkubulim.otf') format('opentype'),
      url('https://cdn.jsdelivr.net/gh/fonts-archive/BMKkubulim/BMKkubulim.ttf') format('truetype');
}
```
...
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/fonts-archive/BMKkubulim/subsets/BMKkubulim-dynamic-subset.css" type="text/css"/>
```
...
```css
font-family: "BM Kkubulim", -apple-system, BlinkMacSystemFont, "Segoe UI",Roboto, Oxygen, Ubuntu, Cantarell, "Open Sans", "Helvetica Neue", sans-serif;
```
